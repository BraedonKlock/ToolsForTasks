...
exports.postAddJob = (req,res,next) => {
  ...
  job.save()
    ...
    .then((employeeDbIds) => {
      ...
      // passing the newly added job into .emit to render in home page (index.ejs) to crew
...
exports.jobDetailsPage = (req,res,next) => {
    ...
    Jobs.findJobById(orgId, id) // finding the job in the database by its unique job id
